...
import com.velagisselint.libraryy.R
...
class BroadcastReceiverForNotify : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            notificationChannel.vibrationPattern =
                longArrayOf(
                    listVibration[0], listVibration[1], listVibration[2],
                    listVibration[2], listVibration[1], listVibration[0]
                )
        ...
        alarmManager?.set(
            ...
            putNextBirthday(
                intent.getSerializableExtra(CONTACT_BIRTHDAY) as Calendar,
    ...
    companion object {
        ...
        val listVibration = LongArray(3) { (it * 100).toLong() }
    }
}
